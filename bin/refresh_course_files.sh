...
FILE_DOWNLOAD_TIMEOUT_SECONDS="${FILE_DOWNLOAD_TIMEOUT_SECONDS:-0}"
FILE_DOWNLOAD_START_TIMEOUT_SECONDS="${FILE_DOWNLOAD_START_TIMEOUT_SECONDS:-180}"
FILE_DOWNLOAD_STALL_TIMEOUT_SECONDS="${FILE_DOWNLOAD_STALL_TIMEOUT_SECONDS:-900}"
FILE_DOWNLOAD_PARALLELISM="${FILE_DOWNLOAD_PARALLELISM:-3}"
FILE_DIRECT_FETCH_MAX_BYTES="${FILE_DIRECT_FETCH_MAX_BYTES:-26214400}"
FILE_DIRECT_FETCH_BATCH_TIMEOUT_SECONDS="${FILE_DIRECT_FETCH_BATCH_TIMEOUT_SECONDS:-180}"
...
OUTPUT_ROOT="${FILE_OUTPUT_ROOT:-$KLMS_DATA_DIR/course_files}"
...
PY
  ...
  /bin/zsh "$KLMS_SH_DIR/run_download_files_step.sh" \
    ...
    "$NEW_FILES_ROOT" \
    "$QUARANTINE_ROOT" \
    "$FILE_DOWNLOAD_START_TIMEOUT_SECONDS" \
    "$FILE_DOWNLOAD_STALL_TIMEOUT_SECONDS" \
    "$FILE_DOWNLOAD_PARALLELISM" \
