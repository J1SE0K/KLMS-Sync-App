...
class ShellEntrypointCleanupTests(unittest.TestCase):
    ...
    def test_ios_device_installer_reports_generic_device_labels(self) -> None:
        ...
        self.assertIn('print -ru2 -- "${device_label}: installed; launch-check skipped', script)
        ...
        self.assertIn("CoreDevice tunnel is not connected", script)
        ...
        self.assertIn("CoreDevice tunnel is ${tunnel_state:-not connected}", launch_script)
        ...
        self.assertIn("CoreDevice tunnel is not connected", readme)
