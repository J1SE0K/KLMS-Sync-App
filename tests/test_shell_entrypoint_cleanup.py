...
class ShellEntrypointCleanupTests(unittest.TestCase):
    ...
    def test_ios_device_installer_reports_generic_device_labels(self) -> None:
        ...
        self.assertIn('print -r -- "launch-check-summary launched=${launched_count} pending=${pending_launch_count} blocked=${blocked_launch_count} manual_launch_needed=${manual_launch_count} failed=${failed_count}"', launch_script)
        ...
        self.assertIn("mac-build|mac-relaunch|mac-accessibility-smoke|mac-tab-response", readiness_script)
        ...
        self.assertIn("launch-check-summary launched=... pending=... blocked=... manual_launch_needed=... failed=...", readme)
