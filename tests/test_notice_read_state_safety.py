...
"""
    ...
    def test_notice_render_batches_adjacent_checklist_lines(self) -> None:
        ...
        self.assertIn("AXUIElementPerformAction(attachment, kAXPressAction", renderer)
        self.assertIn("usleep(checklistPressSettleUsec)", renderer)
...
"""
    ...
    def test_app_notice_requires_functional_notes_renderer(self) -> None:
        ...
        self.assertIn('NOTICE_NATIVE_VERIFY_STABLE_SKIP_FORMAT": runtimeBoolConfigValue(.noticeVerifyStableSkipFormat, default: false)', app_model)
        ...
        self.assertIn('NOTICE_COLLAPSE_SECTIONS": runtimeBoolConfigValue(.noticeCollapseSections, default: false)', app_model)
        self.assertIn('NOTICE_COLLAPSE_COURSES": runtimeBoolConfigValue(.noticeCollapseCourses, default: true)', app_model)
        self.assertIn('NOTICE_COLLAPSE_NOTICE_ITEMS": runtimeBoolConfigValue(.noticeCollapseItems, default: false)', app_model)
        self.assertIn('NOTICE_STYLE_NOTICE_ITEMS_AS_HEADINGS": runtimeBoolConfigValue(.noticeStyleItemsAsHeadings, default: false)', app_model)
