...
final class DashboardDataModelTests: XCTestCase {
    ...
    func testMacDashboardWindowFollowsApprovedWorkstationMockup() throws {
        ...
        XCTAssertTrue(noticeListView.contains("filters: filters"))
        XCTAssertTrue(noticeCategoryPickerView.contains("var filters: DashboardDetailFilters"))
        XCTAssertTrue(noticeCategoryPickerView.contains("noticeMatchesDashboardBaseFilters("))
        XCTAssertTrue(noticeCategoryPickerView.contains("hiddenOnly: filters.hiddenOnly"))
        ...
        XCTAssertTrue(view.contains(".truncationMode(.middle)"))
    ...
    func testIOSDashboardAndSettingsFollowDesignNavigation() throws {
        ...
        XCTAssertTrue(immediateSettingsPanel.contains("withAnimation(.easeInOut(duration: 0.08))"))
        XCTAssertTrue(immediateSettingsPanel.contains(".buttonStyle(KLMSCardButtonStyle(cornerRadius: 12))"))
        XCTAssertTrue(remoteSettingsPanel.contains("withAnimation(.easeInOut(duration: 0.08))"))
        ...
        XCTAssertTrue(relayConnectionPanel.contains("withAnimation(.easeInOut(duration: 0.08))"))
        ...
        XCTAssertTrue(remotePrivacyNote.contains("withAnimation(.easeInOut(duration: 0.08))"))
    ...
    func testSettingsPanelsAreGroupedAndUseNaturalKoreanCopy() throws {
        ...
        XCTAssertFalse(macSettings.contains("defaultExpanded: true"))
