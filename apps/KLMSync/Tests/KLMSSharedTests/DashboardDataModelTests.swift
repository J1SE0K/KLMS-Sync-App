...
final class DashboardDataModelTests: XCTestCase {
    ...
    func testMacAndIOSUseWholeScreenVerticalScroll() throws {
        ...
        XCTAssertTrue(mac.contains("WholeScreenVerticalScrollView(resetID: MacWorkspaceScrollResetKey(section: renderedSection, nonce: scrollResetNonce))"))
    ...
    func testMacWorkspaceAccessibilitySmokeScriptTargetsNavigation() throws {
        ...
        XCTAssertTrue(probe.contains("waitForSelectedValue(on: button"))
        XCTAssertTrue(probe.contains("textAttributes(of: element)"))
    ...
    func testMacDashboardWindowFollowsApprovedWorkstationMockup() throws {
        ...
        XCTAssertTrue(metricGrid.contains(".accessibilityValue(isSelected ? \"선택됨\" : \"\")"))
    ...
    func testMacFileDashboardAvoidsPerRowFilesystemTasks() throws {
        ...
        XCTAssertTrue(mac.contains("DashboardFileDataPrewarmView(snapshot: model.snapshot, signature: model.dashboardFileRenderSignature)"))
    ...
    func testIOSDashboardAndSettingsFollowDesignNavigation() throws {
        ...
        XCTAssertFalse(statusScreen.contains("CompanionDashboardQuickAccessGrid("))
        ...
        XCTAssertFalse(ios.contains("private struct CompanionDashboardQuickAccessGrid"))
        ...
        XCTAssertTrue(statusScreen.contains("@State private var displayedChangeSummary: RemoteChangeSummaryKind?"))
        XCTAssertTrue(statusScreen.contains("@State private var deferredStatusDetailTask: Task<Void, Never>?"))
        XCTAssertTrue(statusScreen.contains("displayedDashboardPreview = nil"))
        XCTAssertTrue(statusScreen.contains("deferredStatusDetailTask = Task { @MainActor in"))
        XCTAssertTrue(statusScreen.contains("await Task.yield()"))
        XCTAssertTrue(statusScreen.contains("try? await Task.sleep(nanoseconds: CompanionLargeList.detailRenderDelayNanoseconds)"))
        ...
        XCTAssertTrue(statusScreen.contains("CompanionEmptyDetailPanel(\n                title: \"항목 선택\""))
        XCTAssertTrue(statusScreen.contains("파일, 과제, 공지, 시험, 캘린더 중 하나를 선택하면"))
        ...
        XCTAssertGreaterThanOrEqual(statusScreen.components(separatedBy: "CompanionItemListPrewarmView(model: model, categories: dashboardPrewarmCategories)").count - 1, 2)
        XCTAssertTrue(statusScreen.contains("private var dashboardPrewarmCategories"))
        XCTAssertTrue(statusScreen.contains("[.files, .assignments, .notices, .exams, .helpDesk]"))
        ...
        XCTAssertTrue(statusScreen.contains("if let kind = displayedChangeSummary"))
        ...
        XCTAssertFalse(settingsScreen.contains("ViewThatFits(in: .horizontal)"))
        ...
        XCTAssertTrue(remoteSettingsPanel.contains("Mac에서 실행할 동기화 방식을 정합니다."))
        XCTAssertTrue(remoteSettingsPanel.contains("변경한 값은 서버에 저장되고 Mac 앱이 받아 적용합니다."))
        ...
        XCTAssertFalse(remoteSettingsPanel.contains("실행 엔진이 쓰는 값을 Mac 설정 파일에 반영합니다."))
        XCTAssertFalse(remoteSettingsPanel.contains("Mac 앱이 받아 config.env에 저장합니다."))
        ...
        XCTAssertTrue(ios.contains("동기화 범위와 캘린더 반영 방식을 정합니다."))
        XCTAssertTrue(ios.contains("파일 확인과 폴더 정리 방식을 정합니다."))
        XCTAssertTrue(ios.contains("숨긴 공지와 변경 없는 메모 처리 방식을 정합니다."))
        XCTAssertTrue(ios.contains("var expandedDetail: String"))
        XCTAssertTrue(ios.contains("var hasExpandedDetail: Bool"))
        XCTAssertTrue(ios.contains("로컬 파일과 KLMS 등록 시각이 같으면 다시 받지 않습니다."))
        XCTAssertTrue(ios.contains("공지 수집은 유지하고 Notes 쓰기만 건너뜁니다."))
        ...
        XCTAssertTrue(remoteSettingGroupSection.contains("@State private var showsDetail = false"))
        XCTAssertTrue(remoteSettingGroupSection.contains("showsDetail.toggle()"))
        XCTAssertTrue(remoteSettingGroupSection.contains("private var shouldShowExpandedDetail"))
        XCTAssertTrue(remoteSettingGroupSection.contains("group.hasExpandedDetail && (showsDetail || (group.isCollapsible && isExpanded))"))
        XCTAssertTrue(remoteSettingGroupSection.contains("CompanionSettingHelpText(group.expandedDetail)"))
        ...
        XCTAssertTrue(immediateSettingsPanel.contains(".accessibilityValue(model.sharedNoticeUpdateNotesEnabled ? \"켜짐\" : \"꺼짐\")"))
    ...
    func testMacAndIOSUseDedicatedLogScreensForRequestHistory() throws {
        ...
        XCTAssertTrue(macRootBody.contains(".frame(width: 264, alignment: .topLeading)"))
        XCTAssertTrue(macRootBody.contains("Rectangle()\n                .fill(Color.klmsMacBorder.opacity(0.76))"))
        XCTAssertTrue(macRootBody.contains(".overlay(alignment: .topLeading)"))
        ...
        XCTAssertTrue(macSelectionMarker.contains(".accessibilityLabel(\"\\(section.title) 내용\")"))
        ...
        XCTAssertTrue(mac.contains("private let workspaceRenderDelayNanoseconds: UInt64 = 35_000_000"))
        ...
        XCTAssertTrue(mac.contains("renderedSection = section"))
        ...
        XCTAssertFalse(remoteRunRequestHistoryPanel.contains("iPhone/iPad나 Windows에서 실행, 파일 열기, 상태 갱신을 요청하면"))
        ...
        XCTAssertTrue(iosStatusScreen.contains("CompanionEmptyDetailPanel(\n                title: \"항목 선택\""))
        ...
        XCTAssertTrue(iosMetricOverview.contains("metricSection(\"주요 항목\", categories: primaryMetricCategories)"))
        XCTAssertTrue(iosMetricOverview.contains("metricSection(\"확인 필요\", categories: attentionMetricCategories)"))
        ...
        XCTAssertTrue(iosMetricOverview.contains("let categories: [DashboardMetricCategory] = [.quarantine, .calendar]"))
    ...
    func testIOSLargeDashboardListsRenderAllItemsLazily() throws {
        ...
        XCTAssertTrue(ios.contains("private struct CompanionItemListPrewarmView: View"))
        XCTAssertTrue(ios.contains("private enum CompanionItemListPreloadStore"))
        XCTAssertTrue(ios.contains("static func defaultCategoryKey(itemsRevision: Int, category: DashboardMetricCategory) -> CompanionItemListInputKey"))
        ...
        XCTAssertTrue(companionModel.contains("nextFilterOptions[category.rawValue] = CompanionItemFilterOptions(items: categoryItems, category: category)"))
        ...
        XCTAssertTrue(deferredControls.contains("@State private var displayedOptionsKey: String?"))
        XCTAssertTrue(deferredControls.contains("if displayedOptionsKey == optionsKey"))
        XCTAssertTrue(deferredControls.contains("CompanionItemListControlsPlaceholder()"))
        XCTAssertTrue(deferredControls.contains("CompanionItemListControls("))
        XCTAssertTrue(deferredControls.contains(".task(id: optionsKey)"))
        XCTAssertTrue(deferredControls.contains("await Task.yield()"))
        XCTAssertTrue(deferredControls.contains("displayedOptionsKey = optionsKey"))
        ...
        XCTAssertTrue(ios.contains("static let regularInitialVisibleLimit = 8"))
        ...
        XCTAssertTrue(selectableRows.contains("@State private var deferredSelectionTask: Task<Void, Never>?"))
        ...
        XCTAssertTrue(selectableRows.contains("deferredSelectionTask?.cancel()"))
        ...
        XCTAssertTrue(selectableRows.contains("deferredSelectionTask = Task { @MainActor in"))
        XCTAssertTrue(selectableRows.contains("await Task.yield()"))
        XCTAssertTrue(selectableRows.contains("try? await Task.sleep(nanoseconds: CompanionLargeList.detailRenderDelayNanoseconds)"))
        XCTAssertTrue(selectableRows.contains("guard !Task.isCancelled, selectedItemID == itemID else { return }"))
        ...
        XCTAssertTrue(inlineRows.contains("@State private var deferredExternalSelectionTask: Task<Void, Never>?"))
        ...
        XCTAssertTrue(inlineRows.contains("deferredExternalSelectionTask = Task { @MainActor in"))
        XCTAssertTrue(inlineRows.contains("await Task.yield()"))
        XCTAssertTrue(inlineRows.contains("try? await Task.sleep(nanoseconds: CompanionLargeList.detailRenderDelayNanoseconds)"))
        XCTAssertTrue(inlineRows.contains("guard !Task.isCancelled,"))
        ...
        XCTAssertTrue(inlineRows.contains(".onDisappear {\n            deferredExternalSelectionTask?.cancel()\n        }"))
        ...
        XCTAssertTrue(serverSyncDataRow.contains(".accessibilityLabel(accessibilityLabelText)"))
        XCTAssertTrue(serverSyncDataRow.contains(".accessibilityValue(isSelected ? \"선택됨\" : \"선택 안 됨\")"))
        XCTAssertTrue(serverSyncDataRow.contains("private var accessibilityLabelText: String"))
        XCTAssertTrue(serverSyncDataRow.contains("kindName"))
        XCTAssertTrue(serverSyncDataRow.contains("metadata"))
        ...
        XCTAssertTrue(workstationCategory.contains("@State private var deferredDetailSelectionTask: Task<Void, Never>?"))
        ...
        XCTAssertTrue(workstationCategory.contains("deferredDetailSelectionTask = Task { @MainActor in"))
        XCTAssertTrue(workstationCategory.contains("await Task.yield()"))
        XCTAssertTrue(workstationCategory.contains("try? await Task.sleep(nanoseconds: CompanionLargeList.detailRenderDelayNanoseconds)"))
        XCTAssertTrue(workstationCategory.contains("guard !Task.isCancelled, selectedItemID == item.id else { return }"))
        XCTAssertTrue(workstationCategory.contains(".onDisappear {\n                deferredDetailSelectionTask?.cancel()\n            }"))
        ...
        XCTAssertTrue(workstationTasks.contains("guard let first = selectedCategoryItems.first else"))
        ...
        XCTAssertTrue(workstationTasks.contains("@State private var deferredDetailSelectionTask: Task<Void, Never>?"))
        ...
        XCTAssertTrue(workstationTasks.contains("deferredDetailSelectionTask = Task { @MainActor in"))
        XCTAssertTrue(workstationTasks.contains("await Task.yield()"))
        XCTAssertTrue(workstationTasks.contains("try? await Task.sleep(nanoseconds: CompanionLargeList.detailRenderDelayNanoseconds)"))
        XCTAssertTrue(workstationTasks.contains("guard !Task.isCancelled, selectedItemID == item.id else { return }"))
        XCTAssertTrue(workstationTasks.contains(".onDisappear {\n                deferredDetailSelectionTask?.cancel()\n            }"))
        ...
        XCTAssertTrue(workstationCalendar.contains("@State private var deferredDetailSelectionTask: Task<Void, Never>?"))
        ...
        XCTAssertTrue(workstationCalendar.contains("deferredDetailSelectionTask = Task { @MainActor in"))
        XCTAssertTrue(workstationCalendar.contains("await Task.yield()"))
        XCTAssertTrue(workstationCalendar.contains("try? await Task.sleep(nanoseconds: CompanionLargeList.detailRenderDelayNanoseconds)"))
        XCTAssertTrue(workstationCalendar.contains("guard !Task.isCancelled, selectedChangeID == change.id else { return }"))
        XCTAssertTrue(workstationCalendar.contains(".onDisappear {\n                deferredDetailSelectionTask?.cancel()\n            }"))
    ...
    func testIOSCalendarDetailHasMailPasteAnalyzerAndSharedCalendarActionLabels() throws {
        ...
        XCTAssertTrue(statusScreen.contains("@State private var deferredStatusDetailTask"))
        ...
        XCTAssertTrue(statusScreen.contains("deferredStatusDetailTask?.cancel()"))
