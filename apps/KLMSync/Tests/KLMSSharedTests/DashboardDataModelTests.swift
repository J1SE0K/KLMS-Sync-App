...
final class DashboardDataModelTests: XCTestCase {
    ...
    func testMacDashboardWindowFollowsApprovedWorkstationMockup() throws {
        ...
        XCTAssertTrue(navigationView.contains(".frame(width: 5, height: 30)"))
        XCTAssertTrue(navigationView.contains(".frame(width: 30, height: 30)"))
        XCTAssertTrue(navigationView.contains(".fill(isSelected ? Color.klmsMacSelectedBorder.opacity(0.16) : Color.clear)"))
        ...
        XCTAssertTrue(navigationView.contains("isSelected ? Color.klmsMacSelectedBorder : Color.clear"))
    ...
    func testSettingsPanelsAreGroupedAndUseNaturalKoreanCopy() throws {
        ...
        XCTAssertTrue(macSettings.contains(".frame(width: 5, height: 30)"))
        XCTAssertTrue(macSettings.contains(".frame(width: 30, height: 30)"))
        XCTAssertTrue(macSettings.contains(".fill(isSelected ? Color.klmsMacSelectedBorder.opacity(0.16) : Color.clear)"))
        ...
        XCTAssertTrue(macSettings.contains("isSelected ? Color.klmsMacSelectedBorder : Color.clear"))
    ...
    func testMacAndIOSUseDedicatedLogScreensForRequestHistory() throws {
        ...
        XCTAssertTrue(macNavigationView.contains(".frame(width: 5, height: 30)"))
        XCTAssertTrue(macNavigationView.contains(".frame(width: 30, height: 30)"))
        XCTAssertTrue(macNavigationView.contains(".fill(isSelected ? Color.klmsMacSelectedBorder.opacity(0.16) : Color.clear)"))
        ...
        XCTAssertTrue(macNavigationView.contains("isSelected ? Color.klmsMacSelectedBorder : Color.clear"))
