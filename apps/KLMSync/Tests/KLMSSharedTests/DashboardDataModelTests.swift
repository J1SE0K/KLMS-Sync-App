...
final class DashboardDataModelTests: XCTestCase {
    ...
    func testIOSDashboardAndSettingsFollowDesignNavigation() throws {
        ...
        XCTAssertTrue(remoteSettingsPanel.contains("ForEach(model.remoteSettingGroups)"))
        XCTAssertFalse(remoteSettingsPanel.contains("RemoteSettingGroup.grouped(settings: model.remoteSettings)"))
