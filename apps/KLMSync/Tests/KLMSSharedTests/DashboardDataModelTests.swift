...
final class DashboardDataModelTests: XCTestCase {
    ...
    func testMacDashboardWindowFollowsApprovedWorkstationMockup() throws {
        ...
        XCTAssertTrue(navigationView.contains("isSelected ? Color.klmsMacSelectedBackground : Color.klmsMacSubtleCardBackground.opacity(0.34)"))
        XCTAssertTrue(navigationView.contains(".overlay(alignment: .leading)"))
        XCTAssertTrue(navigationView.contains(".frame(width: 3)"))
        XCTAssertTrue(navigationView.contains("isSelected ? Color.klmsMacSelectedBorder : Color.klmsMacCommandBorder.opacity(0.42)"))
    ...
    func testIOSDashboardAndSettingsFollowDesignNavigation() throws {
        ...
        XCTAssertTrue(compactTabBar.contains("isSelected ? Color.klmsSelectedBorder : Color.klmsBorder.opacity(0.42)"))
    ...
    func testSettingsPanelsAreGroupedAndUseNaturalKoreanCopy() throws {
        ...
        XCTAssertTrue(macSettings.contains("isSelected ? Color.klmsMacSelectedBackground : Color.klmsMacSubtleCardBackground.opacity(0.34)"))
        XCTAssertTrue(macSettings.contains(".overlay(alignment: .leading)"))
        XCTAssertTrue(macSettings.contains(".frame(width: 3)"))
        XCTAssertTrue(macSettings.contains("isSelected ? Color.klmsMacSelectedBorder : Color.klmsMacCommandBorder.opacity(0.42)"))
    ...
    func testMacAndIOSUseDedicatedLogScreensForRequestHistory() throws {
        ...
        XCTAssertTrue(macNavigationView.contains("isSelected ? Color.klmsMacSelectedBackground : Color.klmsMacSubtleCardBackground.opacity(0.34)"))
        XCTAssertTrue(macNavigationView.contains(".overlay(alignment: .leading)"))
        XCTAssertTrue(macNavigationView.contains(".frame(width: 3)"))
        XCTAssertTrue(macNavigationView.contains("isSelected ? Color.klmsMacSelectedBorder : Color.klmsMacCommandBorder.opacity(0.42)"))
        ...
        XCTAssertTrue(iosSidebarButton.contains("Color.klmsSelectedForeground.opacity(0.12)"))
        ...
        XCTAssertTrue(iosSidebarButton.contains("isSelected ? Color.klmsSelectedBorder : Color.klmsBorder.opacity(0.48)"))
