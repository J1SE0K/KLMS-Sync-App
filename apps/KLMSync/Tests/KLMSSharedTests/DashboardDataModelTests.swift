...
final class DashboardDataModelTests: XCTestCase {
    ...
    func testIOSDashboardAndSettingsFollowDesignNavigation() throws {
        ...
        XCTAssertTrue(companionWorkstationMetrics.contains("static let compactListColumnMinWidth: CGFloat = 276"))
    ...
    func testIOSLargeDashboardListsRenderAllItemsLazily() throws {
        ...
        XCTAssertTrue(workstationCategory.contains("minWidth: CompanionWorkstationMetrics.compactListColumnMinWidth"))
        XCTAssertTrue(workstationCategory.contains("idealWidth: CompanionWorkstationMetrics.compactListColumnIdealWidth"))
        XCTAssertTrue(workstationCategory.contains("maxWidth: CompanionWorkstationMetrics.compactListColumnMaxWidth"))
        XCTAssertTrue(workstationCategory.contains("minWidth: CompanionWorkstationMetrics.compactDetailColumnMinWidth"))
        XCTAssertTrue(workstationCategory.contains("idealWidth: CompanionWorkstationMetrics.compactDetailColumnIdealWidth"))
        ...
        XCTAssertTrue(workstationTasks.contains("minWidth: CompanionWorkstationMetrics.compactListColumnMinWidth"))
        XCTAssertTrue(workstationTasks.contains("idealWidth: CompanionWorkstationMetrics.compactListColumnIdealWidth"))
        XCTAssertTrue(workstationTasks.contains("maxWidth: CompanionWorkstationMetrics.compactListColumnMaxWidth"))
        XCTAssertTrue(workstationTasks.contains("minWidth: CompanionWorkstationMetrics.compactDetailColumnMinWidth"))
        XCTAssertTrue(workstationTasks.contains("idealWidth: CompanionWorkstationMetrics.compactDetailColumnIdealWidth"))
        ...
        XCTAssertTrue(workstationCalendar.contains("minWidth: CompanionWorkstationMetrics.compactListColumnMinWidth"))
        XCTAssertTrue(workstationCalendar.contains("idealWidth: CompanionWorkstationMetrics.compactListColumnIdealWidth"))
        XCTAssertTrue(workstationCalendar.contains("maxWidth: CompanionWorkstationMetrics.compactListColumnMaxWidth"))
        XCTAssertTrue(workstationCalendar.contains("minWidth: CompanionWorkstationMetrics.compactDetailColumnMinWidth"))
        XCTAssertTrue(workstationCalendar.contains("idealWidth: CompanionWorkstationMetrics.compactDetailColumnIdealWidth"))
