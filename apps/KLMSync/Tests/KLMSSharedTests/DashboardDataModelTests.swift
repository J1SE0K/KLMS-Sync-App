...
final class DashboardDataModelTests: XCTestCase {
    ...
    func testIOSDashboardAndSettingsFollowDesignNavigation() throws {
        ...
        XCTAssertFalse(companionSection.contains("case files"))
        XCTAssertFalse(companionSection.contains("case notices"))
        XCTAssertFalse(companionSection.contains("case tasks"))
        XCTAssertFalse(companionSection.contains("case calendar"))
        ...
        XCTAssertTrue(companionSection.contains("title"))
        ...
        XCTAssertTrue(compactTabBar.contains("[.status, .history, .settings]"))
        ...
        XCTAssertTrue(compactTabBar.contains(".shadow(color: isSelected ? Color.klmsSelectedBorder.opacity(0.10) : Color.clear"))
        ...
        XCTAssertFalse(sectionContent.contains("CompanionDashboardCategoryScreen(title: \"파일\", category: .files"))
        XCTAssertFalse(sectionContent.contains("CompanionDashboardCategoryScreen(title: \"공지\", category: .notices"))
        XCTAssertFalse(sectionContent.contains("CompanionTasksScreen"))
        XCTAssertFalse(sectionContent.contains("CompanionDashboardCategoryScreen(title: \"캘린더\", category: .calendar"))
        XCTAssertTrue(sectionContent.contains("CompanionSettingsScreen"))
        XCTAssertTrue(statusScreen.contains("CompanionScreenContainer(title: \"상태\""))
        ...
        XCTAssertTrue(serverSyncDataRow.contains(".shadow(color: isSelected ? Color.klmsSelectedBorder.opacity(0.10) : Color.clear"))
    ...
    func testMacAndIOSUseDedicatedLogScreensForRequestHistory() throws {
        ...
        XCTAssertTrue(macMetricTile.contains("isSelected ? Color.klmsMacSelectedBackground.opacity(0.96) : Color.klmsMacCardBackground"))
        XCTAssertTrue(macMetricTile.contains("isSelected ? Color.klmsMacSelectedForeground : Color.klmsMacPrimaryText"))
        XCTAssertTrue(macMetricTile.contains("isSelected ? Color.klmsMacSelectedBorder.opacity(0.92) : Color.klmsMacBorder"))
        XCTAssertTrue(macMetricTile.contains(".shadow(color: isSelected ? Color.klmsMacSelectedBorder.opacity(0.10) : Color.clear"))
        ...
        XCTAssertTrue(iosSidebarButton.contains(".shadow(color: isSelected ? Color.klmsSelectedBorder.opacity(0.10) : Color.clear"))
        ...
        XCTAssertTrue(iosMetricTile.contains(".shadow(color: isSelected ? Color.klmsSelectedBorder.opacity(0.10) : Color.clear"))
