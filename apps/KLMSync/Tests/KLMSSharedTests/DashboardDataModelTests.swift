...
final class DashboardDataModelTests: XCTestCase {
    ...
    func testMacAndIOSUseSeparatedLightAndDarkThemeTokens() throws {
        ...
        XCTAssertTrue(mac.contains("light: NSColor(calibratedWhite: 0.850"))
        XCTAssertTrue(mac.contains("light: NSColor(calibratedWhite: 0.810"))
        ...
        XCTAssertTrue(ios.contains("light: UIColor(white: 0.850"))
        XCTAssertTrue(ios.contains("light: UIColor(white: 0.810"))
    ...
    func testMacCalendarDashboardHasMailPasteCalendarRegistration() throws {
        ...
        XCTAssertTrue(model.contains("mailCalendarChanges().map(serverRelayCalendarChange)"))
