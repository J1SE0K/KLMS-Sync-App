...
final class DashboardDataModelTests: XCTestCase {
    ...
    func testMacDashboardWindowFollowsApprovedWorkstationMockup() throws {
        ...
        XCTAssertTrue(rootActionButtonStyle.contains("Color.klmsMacCommandButtonBackground.opacity(0.90)"))
    ...
    func testIOSDashboardAndSettingsFollowDesignNavigation() throws {
        ...
        XCTAssertFalse(actionButtonStyle.contains("background(isPressed:"))
        XCTAssertFalse(actionButtonStyle.contains("border(isPressed:"))
        XCTAssertTrue(actionButtonStyle.contains("return AnyShapeStyle(Color.klmsCommandButtonBackground.opacity(0.90))"))
        XCTAssertTrue(actionButtonStyle.contains("return AnyShapeStyle(Color.klmsPrimaryCommandButtonBackground)"))
        ...
        XCTAssertTrue(actionButtonStyle.contains("return AnyShapeStyle(Color.klmsSuccessBackground)"))
        XCTAssertTrue(actionButtonStyle.contains("return AnyShapeStyle(color.opacity(0.10))"))
    ...
    func testMacAndIOSUseDedicatedLogScreensForRequestHistory() throws {
        ...
        XCTAssertEqual(mac.components(separatedBy: "@ObservedObject var model: KLMSMacModel").count - 1, 2)
        ...
        XCTAssertTrue(workstationBody.contains("CommandPanelView(model: model, openRunLog: openRunLog)"))
