...
final class DashboardDataModelTests: XCTestCase {
    ...
    func testMacAndIOSUseDedicatedLogScreensForRequestHistory() throws {
        ...
        XCTAssertTrue(deferredMacWorkspacePanel.contains(".overlay(alignment: .topLeading)"))
        ...
        XCTAssertTrue(macWorkstationLayoutView.contains(".accessibilityIdentifier(\"workspace-marker-\\(selectedSection.rawValue)\")"))
        XCTAssertFalse(macWorkstationLayoutView.contains(".accessibilityIdentifier(\"workspace-content-\\(selectedSection.rawValue)\")"))
        ...
        XCTAssertTrue(workstationBody.contains(".accessibilityIdentifier(\"workspace-marker-\\(selectedSection.rawValue)\")"))
        XCTAssertFalse(workstationBody.contains(".accessibilityIdentifier(\"workspace-content-\\(selectedSection.rawValue)\")"))
