...
final class DashboardDataModelTests: XCTestCase {
    ...
    func testIOSServerActionRefreshesUseNarrowScopes() throws {
        ...
        XCTAssertTrue(createManualCalendarAction.contains("schedulePostActionRefresh(scope: .itemActions)"))
        ...
        XCTAssertTrue(createCalendarAction.contains("schedulePostActionRefresh(scope: .itemActions)"))
