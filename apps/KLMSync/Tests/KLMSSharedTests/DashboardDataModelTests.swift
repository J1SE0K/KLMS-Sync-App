...
final class DashboardDataModelTests: XCTestCase {
    ...
    func testMacAndIOSUseDedicatedLogScreensForRequestHistory() throws {
        ...
        XCTAssertTrue(macMetricTile.contains(".shadow(color: isSelected ? tint.opacity(0.12) : Color.clear"))
        ...
        XCTAssertFalse(iosWorkstationDetailPanel.contains("\"선택 항목\""))
        XCTAssertTrue(iosWorkstationDetailPanel.contains("Text(\"목록\")"))
