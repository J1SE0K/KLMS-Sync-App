...
final class DashboardDataModelTests: XCTestCase {
    ...
    func testIOSDashboardAndSettingsFollowDesignNavigation() throws {
        ...
        XCTAssertTrue(flowChipLayout.contains("Color.klmsCommandButtonBackground.opacity(0.92)"))
        XCTAssertTrue(flowChipLayout.contains("Color.klmsBorder.opacity(0.95)"))
        ...
        XCTAssertTrue(remoteChangeSummaryDetail.contains("ForEach(changedItems)"))
        XCTAssertFalse(remoteChangeSummaryDetail.contains("changedItems.prefix(12)"))
