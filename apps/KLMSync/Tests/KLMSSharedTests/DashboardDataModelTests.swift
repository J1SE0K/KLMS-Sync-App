...
final class DashboardDataModelTests: XCTestCase {
    ...
    func testMacDashboardWindowFollowsApprovedWorkstationMockup() throws {
        ...
        XCTAssertTrue(navigationView.contains("WorkspaceNavigationSelectionMarker(section: displayedSelection)"))
        XCTAssertTrue(navigationView.contains("let isSelected = displayedSelection == section"))
        XCTAssertTrue(navigationView.contains("guard displayedSelection != section else {"))
        XCTAssertTrue(navigationView.contains("resetCurrentSectionScroll()"))
        XCTAssertTrue(navigationView.contains("select(section)"))
        XCTAssertTrue(navigationView.contains("@State private var displayedSelection = KLMSMacSection.dashboard"))
        XCTAssertTrue(navigationView.contains("@State private var selectionCommitTask: Task<Void, Never>?"))
        XCTAssertTrue(navigationView.contains("selectionCommitTask = Task { @MainActor in"))
        XCTAssertTrue(navigationView.contains("await Task.yield()"))
    ...
    func testMacAndIOSUseDedicatedLogScreensForRequestHistory() throws {
        ...
        XCTAssertTrue(macRootBody.contains(".accessibilityIdentifier(\"workspace-scroll-\\(renderedSection.rawValue)\")"))
        ...
        XCTAssertTrue(mac.contains(".onChange(of: selectedSection) { _, nextSection in"))
        XCTAssertTrue(mac.contains("queueRenderedSection(nextSection)"))
        XCTAssertTrue(mac.contains(".onDisappear {\n            workspaceRenderTask?.cancel()"))
        XCTAssertTrue(mac.contains("private func queueRenderedSection(_ section: KLMSMacSection)"))
        XCTAssertTrue(mac.contains("@State private var workspaceRenderTask: Task<Void, Never>?"))
        XCTAssertTrue(mac.contains("workspaceRenderTask?.cancel()"))
        XCTAssertTrue(mac.contains("workspaceRenderTask = Task { @MainActor in"))
        XCTAssertTrue(mac.contains("await Task.yield()"))
        XCTAssertTrue(macRootBody.contains("selectedSection: renderedSection"))
        ...
        XCTAssertTrue(macNavigationView.contains("WorkspaceNavigationSelectionMarker(section: displayedSelection)"))
        ...
        XCTAssertTrue(macNavigationView.contains("guard displayedSelection != section else {"))
        ...
        XCTAssertFalse(ios.contains("await Task.yield()"))
    ...
    func testIOSLargeDashboardListsRenderAllItemsLazily() throws {
        ...
        XCTAssertFalse(ios.contains("detailRenderDelayNanoseconds"))
        ...
        XCTAssertFalse(selectableRows.contains("deferredSelectionTask"))
        ...
        XCTAssertTrue(selectableRows.contains("guard selectedItemID == itemID else { return }"))
        ...
        XCTAssertFalse(inlineRows.contains("@State private var deferredExternalSelectionTask"))
        ...
        XCTAssertFalse(inlineRows.contains("deferredExternalSelectionTask"))
        ...
        XCTAssertTrue(workstationCategory.contains("return items.first { $0.id == selectedItemID }"))
        ...
        XCTAssertTrue(workstationCategory.contains("items.contains(where: { $0.id == selectedItemID })"))
        ...
        XCTAssertTrue(workstationTasks.contains("return selectedCategoryItems.first { $0.id == selectedItemID }"))
        ...
        XCTAssertTrue(workstationTasks.contains("selectedCategoryItems.contains(where: { $0.id == selectedItemID })"))
        ...
        XCTAssertTrue(workstationCalendar.contains("return changes.first { $0.id == selectedChangeID }"))
        XCTAssertTrue(workstationCalendar.contains("changes.contains(where: { $0.id == selectedChangeID })"))
