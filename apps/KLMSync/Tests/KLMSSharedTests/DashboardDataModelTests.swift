...
final class DashboardDataModelTests: XCTestCase {
    ...
    func testIOSSettingActionsUpdateRemoteSettingsImmediately() throws {
        ...
        XCTAssertTrue(createSettingAction.contains("recentSettingActions.insert(optimisticAction, at: 0)"))
        ...
        XCTAssertTrue(createSettingAction.contains("recentSettingActions.removeAll { $0.key == setting.key }"))
