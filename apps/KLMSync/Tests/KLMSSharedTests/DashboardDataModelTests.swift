...
final class DashboardDataModelTests: XCTestCase {
    ...
    func testMacDashboardWindowFollowsApprovedWorkstationMockup() throws {
        ...
        XCTAssertTrue(dashboardSummaryContent.contains("ViewThatFits(in: .horizontal)"))
        XCTAssertTrue(dashboardSummaryContent.contains("DashboardLogSummaryPanelView(model: model)"))
        XCTAssertTrue(dashboardSummaryContent.contains(".frame(width: 285, alignment: .topLeading)"))
    ...
    func testSettingsPanelsAreGroupedAndUseNaturalKoreanCopy() throws {
        ...
        XCTAssertTrue(macSettings.contains("withAnimation(.easeInOut(duration: 0.08))"))
        ...
        XCTAssertTrue(macSettings.contains("Text(summary)"))
        XCTAssertTrue(macSettings.contains("SettingsExpansionBadge(isExpanded: isExpanded)"))
