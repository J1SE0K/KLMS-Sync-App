...
final class DashboardDataModelTests: XCTestCase {
    ...
    func testIOSDashboardAndSettingsFollowDesignNavigation() throws {
        ...
        XCTAssertTrue(dashboardSyncCard.contains(".font(.caption2.weight(.semibold))"))
        ...
        XCTAssertTrue(metricTile.contains(".font(.caption2.weight(.semibold))"))
    ...
    func testMacAndIOSUseDedicatedLogScreensForRequestHistory() throws {
        ...
        XCTAssertTrue(iosSidebarButton.contains(".font(.caption.weight(isSelected ? .semibold : .regular))"))
    ...
    func testIOSCompanionUsesAdaptiveIPadNavigation() throws {
        ...
        XCTAssertTrue(ios.contains(".frame(width: 150)"))
