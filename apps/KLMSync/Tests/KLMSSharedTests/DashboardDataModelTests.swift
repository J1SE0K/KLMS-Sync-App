...
final class DashboardDataModelTests: XCTestCase {
    ...
    func testIOSDashboardAndSettingsFollowDesignNavigation() throws {
        ...
        XCTAssertTrue(remoteDiagnosticPanel.contains("Text(isPanelExpanded ? \"펼침\" : \"접힘\")"))
        XCTAssertTrue(remoteDiagnosticPanel.contains("RoundedRectangle(cornerRadius: 14)"))
        XCTAssertTrue(remoteDiagnosticPanel.contains("Text(isAdvancedExpanded ? \"펼침\" : \"접힘\")"))
        ...
        XCTAssertTrue(remotePrivacyNote.contains("Text(isExpanded ? \"펼침\" : \"접힘\")"))
    ...
    func testSettingsPanelsAreGroupedAndUseNaturalKoreanCopy() throws {
        ...
        XCTAssertTrue(ios.contains("Text(isPanelExpanded ? \"펼침\" : \"접힘\")"))
        XCTAssertTrue(ios.contains("Text(isAdvancedExpanded ? \"펼침\" : \"접힘\")"))
