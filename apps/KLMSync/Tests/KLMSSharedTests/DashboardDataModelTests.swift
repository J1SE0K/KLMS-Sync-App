...
final class DashboardDataModelTests: XCTestCase {
    ...
    func testMacDashboardWindowFollowsApprovedWorkstationMockup() throws {
        ...
        XCTAssertTrue(navigationView.contains(".fill(isSelected ? Color.klmsMacCardBackground.opacity(0.72) : Color.clear)"))
    ...
    func testIOSDashboardAndSettingsFollowDesignNavigation() throws {
        ...
        XCTAssertTrue(compactTabBar.contains("LazyHStack(spacing: 8)"))
        ...
        XCTAssertTrue(compactTabBar.contains(".frame(minWidth: 76, minHeight: 44)"))
    ...
    func testSettingsPanelsAreGroupedAndUseNaturalKoreanCopy() throws {
        ...
        XCTAssertTrue(macSettings.contains(".fill(isSelected ? Color.klmsMacCardBackground.opacity(0.72) : Color.clear)"))
    ...
    func testMacAndIOSUseDedicatedLogScreensForRequestHistory() throws {
        ...
        XCTAssertTrue(macNavigationView.contains(".fill(isSelected ? Color.klmsMacCardBackground.opacity(0.72) : Color.clear)"))
