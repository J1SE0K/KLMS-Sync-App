...
final class DashboardDataModelTests: XCTestCase {
    ...
    func testIOSDashboardAndSettingsFollowDesignNavigation() throws {
        ...
        XCTAssertTrue(remoteSettingsPanelContent.contains("private var settingGroupNavigation: some View"))
        XCTAssertTrue(remoteSettingsPanelContent.contains("Text(\"설정 섹션\")"))
        XCTAssertTrue(remoteSettingsPanelContent.contains("settingGroupNavigationButton("))
        XCTAssertTrue(remoteSettingsPanelContent.contains("private var visibleSettingGroups: [RemoteSettingGroup]"))
