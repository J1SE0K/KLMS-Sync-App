...
final class DashboardDataModelTests: XCTestCase {
    ...
    func testIOSDashboardAndSettingsFollowDesignNavigation() throws {
        ...
        XCTAssertTrue(compactTabBar.contains(".animation(.easeOut(duration: 0.10), value: isSelected)"))
    ...
    func testMacAndIOSUseDedicatedLogScreensForRequestHistory() throws {
        ...
        XCTAssertTrue(iosSidebarButton.contains(".animation(.easeOut(duration: 0.10), value: isSelected)"))
