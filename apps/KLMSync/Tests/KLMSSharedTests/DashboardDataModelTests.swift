...
final class DashboardDataModelTests: XCTestCase {
    ...
    func testIOSRefreshesServerSummaryWhenAppBecomesActive() throws {
        ...
        XCTAssertTrue(rootView.contains("guard !model.isUsingUITestRunningFixture else { return }"))
        XCTAssertTrue(rootView.contains("guard newPhase == .active, !model.isUsingUITestRunningFixture else { return }"))
