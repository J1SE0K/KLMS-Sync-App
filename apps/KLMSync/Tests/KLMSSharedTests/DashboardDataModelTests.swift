...
final class DashboardDataModelTests: XCTestCase {
    ...
    func testMacWorkspaceAccessibilitySmokeScriptTargetsNavigation() throws {
        ...
        XCTAssertTrue(script.contains("app.activate(options: [.activateIgnoringOtherApps, .activateAllWindows])"))
        ...
        XCTAssertTrue(probe.contains("app.activate(options: [.activateIgnoringOtherApps, .activateAllWindows])"))
    ...
    func testIOSLargeDashboardListsRenderAllItemsLazily() throws {
        ...
        XCTAssertFalse(listData.contains("var filteredItemIDs: Set<String>"))
        XCTAssertFalse(listData.contains("Set(sortedFiltered.map(\\.id))"))
        ...
        XCTAssertFalse(syncDataPanel.contains("itemIDs: listData.filteredItemIDs"))
        ...
        XCTAssertFalse(inlineDetail.contains("itemIDs: listData.filteredItemIDs"))
        ...
        XCTAssertTrue(inlineRows.contains("return items.contains { $0.id == itemID }"))
        XCTAssertFalse(inlineRows.contains("return itemIDs.contains(itemID)"))
