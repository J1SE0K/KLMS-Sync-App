...
final class DashboardDataModelTests: XCTestCase {
    ...
    func testMacDashboardWindowFollowsApprovedWorkstationMockup() throws {
        ...
        XCTAssertTrue(dashboardSummaryContent.contains("dashboardDetailContent(activeDetail: currentActiveDetail, renderedDetail: currentRenderedDetail)"))
        ...
        XCTAssertTrue(dashboardSummaryContent.contains("private func deferDashboardDetail"))
        ...
        XCTAssertTrue(dashboardSummaryContent.contains("renderedDetail = nil"))
        ...
        XCTAssertTrue(view.contains("선택은 바로 반영했고, 큰 목록만 잠시 뒤에 불러옵니다."))
    ...
    func testIOSDashboardAndSettingsFollowDesignNavigation() throws {
        ...
        XCTAssertTrue(dashboardMetricCategory.contains("[.files, .assignments, .exams, .notices, .calendar, .helpDesk]"))
    ...
    func testMacAndIOSUseDedicatedLogScreensForRequestHistory() throws {
        ...
        XCTAssertTrue(iosRemoteLogSummaryPanel.contains("상세는 오른쪽에 표시됩니다."))
        ...
        XCTAssertTrue(iosCompanionEmptyDetailPanel.contains("minHeight: 132"))
        ...
        XCTAssertTrue(iosSharedRunLogsView.contains("단계별 시간과 마지막 로그입니다. 지우면 모든 기기에서 사라집니다."))
    ...
    func testMacCalendarDashboardHasMailPasteCalendarRegistration() throws {
        ...
        XCTAssertTrue(dashboardSummary.contains("renderedDetail = nil"))
