...
final class DashboardDataModelTests: XCTestCase {
    ...
    func testIOSDashboardAndSettingsFollowDesignNavigation() throws {
        ...
        let iosYearFieldIndex = try XCTUnwrap(companionItemListControls.range(of: "companionInlinePickerField(\n                                title: \"연도\"")?.lowerBound)
        let iosSemesterFieldIndex = try XCTUnwrap(companionItemListControls.range(of: "companionInlinePickerField(\n                                title: \"학기\"")?.lowerBound)
        let iosCourseFieldIndex = try XCTUnwrap(companionItemListControls.range(of: "companionInlinePickerField(\n                            title: \"과목\"")?.lowerBound)
        ...
        XCTAssertFalse(companionItemListControls.contains("Menu {"))
        XCTAssertFalse(companionItemListControls.contains(".buttonStyle(.plain)"))
        XCTAssertTrue(companionItemListControls.contains("@State private var expandedPickerID: String?"))
        XCTAssertTrue(companionItemListControls.contains("expandedPickerID = isExpanded ? nil : title"))
        XCTAssertFalse(companionItemListControls.contains("expandedPickerID = nil"))
