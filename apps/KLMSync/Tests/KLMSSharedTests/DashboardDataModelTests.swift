...
final class DashboardDataModelTests: XCTestCase {
    ...
    func testIOSDeviceInstallHelperWaitsForUnavailableDevices() throws {
        ...
        XCTAssertTrue(installScript.contains("CoreDevice tunnel is not connected"))
        ...
        XCTAssertTrue(installScript.contains("install-summary installed=${installed_count} launched=${launched_count} installed_only=${installed_only_count} manual_launch_needed=${manual_launch_count} failed=${failed_count}"))
        ...
        XCTAssertTrue(launchCheckScript.contains("CoreDevice tunnel is ${tunnel_state:-not connected}"))
        ...
        XCTAssertTrue(readinessScript.contains("mac-build|mac-relaunch|mac-accessibility-smoke|mac-tab-response"))
        ...
        XCTAssertTrue(readme.contains("install-summary installed=... launched=... installed_only=... manual_launch_needed=... failed=..."))
        ...
        XCTAssertTrue(readme.contains("CoreDevice tunnel is not connected"))
    ...
    func testMacAndIOSDirectInteractionAnimationsStayFast() throws {
        ...
        XCTAssertTrue(iosDeferredItemDetailPanel.contains("DeferredServerSyncItemDetailPreparingPanel(item: item)"))
    ...
    func testIOSDashboardAndSettingsFollowDesignNavigation() throws {
        ...
        XCTAssertTrue(deferredInlineItemDetail.contains("@State private var renderedItemID: String?"))
        XCTAssertTrue(deferredInlineItemDetail.contains("if renderedItemID == item.id"))
    ...
    func testFileCleanupCardsRequireActualCleanupDetails() throws {
        ...
        XCTAssertTrue(ios.contains("if metricSnapshot.hasVisibleChangeSummary"))
    ...
    func testMacAndIOSUseDedicatedLogScreensForRequestHistory() throws {
        ...
        XCTAssertTrue(iosMetricOverview.contains("if metricSnapshot.shouldShowAttentionMetricSection {"))
    ...
    func testIOSLargeDashboardListsRenderAllItemsLazily() throws {
        ...
        XCTAssertTrue(inlineRows.contains("deferredExternalSelectionTask?.cancel()"))
        XCTAssertFalse(inlineRows.contains("Task.sleep"))
        XCTAssertTrue(inlineRows.contains("await Task.yield()"))
        XCTAssertTrue(inlineRows.contains("guard !Task.isCancelled, optimisticExternalSelectedItemID == itemID else { return }"))
