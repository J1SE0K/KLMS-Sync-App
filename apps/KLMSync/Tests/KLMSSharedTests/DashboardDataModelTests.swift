...
final class DashboardDataModelTests: XCTestCase {
    ...
    func testSettingsPanelsAreGroupedAndUseNaturalKoreanCopy() throws {
        ...
        XCTAssertFalse(companionSettingsSubsectionCard.contains("DeferredInteractionExpansion(isExpanded: isExpanded)"))
        XCTAssertTrue(companionSettingsSubsectionCard.contains("if isExpanded"))
