...
final class DashboardDataModelTests: XCTestCase {
    ...
    func testIOSDeviceInstallHelperWaitsForUnavailableDevices() throws {
        ...
        XCTAssertTrue(launchCheckScript.contains("launch-check-summary launched=${launched_count} pending=${pending_launch_count} blocked=${blocked_launch_count} manual_launch_needed=${manual_launch_count} failed=${failed_count}"))
