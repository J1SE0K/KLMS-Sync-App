...
final class DashboardDataModelTests: XCTestCase {
    ...
    func testIOSDashboardAndSettingsFollowDesignNavigation() throws {
        ...
        XCTAssertFalse(remoteSettingGroupSection.contains("DeferredInteractionExpansion(isExpanded: isExpanded)"))
        XCTAssertTrue(remoteSettingGroupSection.contains("if isExpanded"))
