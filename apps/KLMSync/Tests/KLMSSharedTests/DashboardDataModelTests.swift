...
final class DashboardDataModelTests: XCTestCase {
    ...
    func testIOSDashboardAndSettingsFollowDesignNavigation() throws {
        ...
        XCTAssertTrue(remoteSettingRow.contains("private func settingChoiceChip(_ option: String) -> some View"))
        ...
        XCTAssertTrue(companionItemListControls.contains("#if canImport(UIKit)"))
        XCTAssertTrue(companionItemListControls.contains("CompanionUIKitChoiceMenuButton("))
        XCTAssertTrue(ios.contains("private struct CompanionUIKitChoiceMenuButton<Option: Hashable>: UIViewRepresentable"))
        XCTAssertTrue(ios.contains("UIAlertController(title: title, message: nil, preferredStyle: .actionSheet)"))
        XCTAssertTrue(ios.contains("companionScopePickerLabel(title, value: selection.wrappedValue)"))
        XCTAssertFalse(ios.contains("button.showsMenuAsPrimaryAction = true"))
        XCTAssertFalse(ios.contains("button.menu = UIMenu(children: options.map"))
        XCTAssertTrue(companionItemListControls.contains("Menu {"))
        XCTAssertTrue(companionItemListControls.contains(".buttonStyle(.plain)"))
        ...
        XCTAssertTrue(companionItemListControls.contains(".frame(maxWidth: .infinity, minHeight: Self.menuHeight, maxHeight: Self.menuHeight, alignment: .leading)"))
        ...
        XCTAssertTrue(remoteSettingRow.contains("@State private var isChoiceExpanded = false"))
        XCTAssertTrue(remoteSettingRow.contains("isChoiceExpanded.toggle()"))
        XCTAssertTrue(remoteSettingRow.contains("settingChoiceChip(option)"))
        XCTAssertTrue(remoteSettingRow.contains(".background(Color.klmsSubtleCardBackground, in: RoundedRectangle(cornerRadius: 9))"))
        XCTAssertTrue(remoteSettingRow.contains(".companionStableTap(cornerRadius: 9)"))
        XCTAssertTrue(remoteSettingRow.contains("RoundedRectangle(cornerRadius: 9)"))
    ...
    func testIOSServerActionRefreshesUseNarrowScopes() throws {
        ...
        XCTAssertTrue(createManualCalendarAction.contains("await createCalendarEventOnDevice(title: title, edit: edit, change: nil)"))
