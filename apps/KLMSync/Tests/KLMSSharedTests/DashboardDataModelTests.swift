...
final class DashboardDataModelTests: XCTestCase {
    ...
    func testMacDashboardWindowFollowsApprovedWorkstationMockup() throws {
        ...
        XCTAssertTrue(app.contains("WindowGroup(\"KLMS Sync\")"))
        XCTAssertTrue(app.contains(".defaultSize(width: KLMSWindowMetrics.initialWidth, height: KLMSWindowMetrics.initialHeight)"))
        XCTAssertTrue(app.contains("CommandGroup(replacing: .newItem)"))
        ...
        XCTAssertTrue(app.contains("KLMSDashboardWindowCoordinator.shared.scheduleBootstrapIfNeeded()"))
        ...
        XCTAssertTrue(navigationView.contains("Color.klmsMacSelectedForeground.opacity(0.12)"))
        ...
        XCTAssertTrue(navigationView.contains("isSelected ? Color.klmsMacSelectedBackground : Color.clear"))
        XCTAssertTrue(navigationView.contains(".overlay(alignment: .leading)"))
        XCTAssertTrue(navigationView.contains(".frame(width: 3)"))
        XCTAssertTrue(navigationView.contains("isSelected ? Color.klmsMacSelectedBorder : Color.klmsMacCommandBorder.opacity(0.32)"))
    ...
    func testIOSDashboardAndSettingsFollowDesignNavigation() throws {
        ...
        XCTAssertTrue(compactTabBar.contains("ScrollView(.horizontal, showsIndicators: false)"))
        XCTAssertTrue(compactTabBar.contains("LazyHStack(spacing: 6)"))
        ...
        XCTAssertTrue(compactTabBar.contains(".frame(minWidth: compactTabMinWidth(for: section), minHeight: 42)"))
        XCTAssertTrue(compactTabBar.contains("private func compactTabMinWidth(for section: CompanionAppSection) -> CGFloat"))
        XCTAssertFalse(compactTabBar.contains(".frame(maxWidth: .infinity, minHeight: 44)"))
        ...
        XCTAssertTrue(compactTabBar.contains(": Color.clear"))
        XCTAssertTrue(compactTabBar.contains("isSelected ? Color.klmsSelectedBorder : Color.clear"))
        XCTAssertTrue(compactTabBar.contains(".shadow(color: isSelected ? Color.black.opacity(0.055) : Color.clear"))
    ...
    func testSettingsPanelsAreGroupedAndUseNaturalKoreanCopy() throws {
        ...
        XCTAssertTrue(macSettings.contains(".frame(width: 30, height: 30)"))
        XCTAssertTrue(macSettings.contains("Color.klmsMacSelectedForeground.opacity(0.12)"))
        ...
        XCTAssertTrue(macSettings.contains("isSelected ? Color.klmsMacSelectedBackground : Color.clear"))
        XCTAssertTrue(macSettings.contains(".overlay(alignment: .leading)"))
        XCTAssertTrue(macSettings.contains(".frame(width: 3)"))
        XCTAssertTrue(macSettings.contains("isSelected ? Color.klmsMacSelectedBorder : Color.klmsMacCommandBorder.opacity(0.32)"))
    ...
    func testMacAndIOSUseDedicatedLogScreensForRequestHistory() throws {
        ...
        XCTAssertTrue(macNavigationView.contains("Color.klmsMacSelectedForeground.opacity(0.12)"))
        ...
        XCTAssertTrue(macNavigationView.contains("isSelected ? Color.klmsMacSelectedBackground : Color.clear"))
        XCTAssertTrue(macNavigationView.contains(".overlay(alignment: .leading)"))
        XCTAssertTrue(macNavigationView.contains(".frame(width: 3)"))
        XCTAssertTrue(macNavigationView.contains("isSelected ? Color.klmsMacSelectedBorder : Color.klmsMacCommandBorder.opacity(0.32)"))
        XCTAssertTrue(mac.contains("light: NSColor(red: 0.858, green: 0.839, blue: 0.773, alpha: 1.0)"))
        XCTAssertTrue(mac.contains("dark: NSColor(red: 0.282, green: 0.263, blue: 0.218, alpha: 1.0)"))
        XCTAssertTrue(mac.contains("dark: NSColor(red: 0.941, green: 0.875, blue: 0.722, alpha: 0.68)"))
        ...
        XCTAssertTrue(iosSidebarButton.contains("RoundedRectangle(cornerRadius: 3)"))
        XCTAssertTrue(iosSidebarButton.contains(".frame(width: 4, height: isCompact ? 26 : 28)"))
        XCTAssertTrue(iosSidebarButton.contains(".frame(width: isCompact ? 20 : 22)"))
        ...
        XCTAssertTrue(iosSidebarButton.contains(": Color.clear"))
        XCTAssertTrue(iosSidebarButton.contains("isSelected ? Color.klmsSelectedBorder : Color.clear"))
        XCTAssertTrue(ios.contains("light: UIColor(red: 0.858, green: 0.839, blue: 0.773, alpha: 1.0)"))
        XCTAssertTrue(ios.contains("dark: UIColor(red: 0.282, green: 0.263, blue: 0.218, alpha: 1.0)"))
        XCTAssertTrue(ios.contains("dark: UIColor(red: 0.941, green: 0.875, blue: 0.722, alpha: 0.68)"))
        XCTAssertTrue(iosSidebarButton.contains(".shadow(color: isSelected ? Color.black.opacity(0.055) : Color.clear"))
    ...
    func testMacCalendarDashboardHasMailPasteCalendarRegistration() throws {
        ...
        XCTAssertTrue(dashboardSummary.contains(".frame(minWidth: 360, idealWidth: 430, maxWidth: 520"))
