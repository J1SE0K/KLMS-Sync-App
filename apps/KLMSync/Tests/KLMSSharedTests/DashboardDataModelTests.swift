...
final class DashboardDataModelTests: XCTestCase {
    ...
    func testMacAndIOSUseDedicatedLogScreensForRequestHistory() throws {
        ...
        XCTAssertTrue(workstationBody.contains(".accessibilityIdentifier(workspaceContainerAccessibilityIdentifier)"))
        XCTAssertTrue(workstationBody.contains("selectedSection == .dashboard\n            ? \"workspace-content-dashboard\"\n            : \"workspace-host-\\(selectedSection.rawValue)\""))
