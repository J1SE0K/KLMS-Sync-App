...
final class DashboardDataModelTests: XCTestCase {
    ...
    func testMacDashboardWindowFollowsApprovedWorkstationMockup() throws {
        ...
        XCTAssertTrue(app.contains("window.setAccessibilityElement(true)"))
        XCTAssertTrue(app.contains("window.setAccessibilityRole(.window)"))
        XCTAssertTrue(app.contains("window.setAccessibilityTitle(\"KLMS Sync\")"))
