...
final class DashboardDataModelTests: XCTestCase {
    ...
    func testIOSLargeDashboardListsAreProgressivelyRendered() throws {
        ...
        XCTAssertTrue(inlineRows.contains("Task { @MainActor in"))
        XCTAssertTrue(selectableRows.contains("private func increaseVisibleLimit()"))
        XCTAssertTrue(selectableRows.contains("Task { @MainActor in"))
