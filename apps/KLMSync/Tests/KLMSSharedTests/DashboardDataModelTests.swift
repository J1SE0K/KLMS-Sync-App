...
final class DashboardDataModelTests: XCTestCase {
    ...
    func testMacAndIOSUseDedicatedLogScreensForRequestHistory() throws {
        ...
        XCTAssertTrue(iosSplitRoot.contains(".frame(width: 154)"))
        ...
        XCTAssertTrue(iosSidebar.contains("isCompact: true"))
        ...
        XCTAssertTrue(iosSidebarButton.contains("minHeight: isCompact ? 40 : 36"))
        XCTAssertTrue(iosSidebarButton.contains("Color.klmsSelectedBackground"))
        XCTAssertTrue(iosSidebarButton.contains(": Color.klmsCardBackground.opacity(0.58)"))
        XCTAssertTrue(iosSidebarButton.contains("isSelected ? Color.klmsSelectedBorder : Color.klmsBorder.opacity(0.52)"))
    ...
    func testIOSCompanionUsesAdaptiveIPadNavigation() throws {
        ...
        XCTAssertTrue(ios.contains(".frame(width: 154)"))
        ...
        XCTAssertTrue(ios.contains(".frame(maxWidth: .infinity, minHeight: isCompact ? 40 : 36, alignment: .leading)"))
