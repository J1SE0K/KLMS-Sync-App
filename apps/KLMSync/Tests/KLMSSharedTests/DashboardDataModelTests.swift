...
final class DashboardDataModelTests: XCTestCase {
    ...
    func testIOSLargeDashboardListsRenderAllItemsLazily() throws {
        ...
        XCTAssertTrue(ios.contains("static let initialVisibleLimit = 16"))
        XCTAssertTrue(ios.contains("static let previewVisibleLimit = 10"))
        XCTAssertTrue(ios.contains("static let calendarVisibleLimit = 16"))
