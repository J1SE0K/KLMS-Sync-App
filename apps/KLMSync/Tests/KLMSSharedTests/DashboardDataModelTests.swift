...
final class DashboardDataModelTests: XCTestCase {
    ...
    func testIOSDashboardAndSettingsFollowDesignNavigation() throws {
        ...
        XCTAssertTrue(immediateSettingRow.contains("@State private var isDetailExpanded = false"))
        XCTAssertTrue(immediateSettingRow.contains("CompanionDetailDisclosureBadge(isExpanded: isDetailExpanded)"))
        XCTAssertTrue(immediateSettingRow.contains("CompanionSettingHelpText(detail)"))
    ...
    func testSettingsPanelsAreGroupedAndUseNaturalKoreanCopy() throws {
        ...
        XCTAssertTrue(macSettings.contains("@State private var isDescriptionExpanded = false"))
        XCTAssertTrue(macSettings.contains("Text(isDescriptionExpanded ? \"설명 접기\" : \"설명 보기\")"))
        ...
        XCTAssertTrue(ios.contains("@State private var isDetailExpanded = false"))
        XCTAssertTrue(ios.contains("private struct CompanionDetailDisclosureBadge"))
        XCTAssertTrue(ios.contains("CompanionDetailDisclosureBadge(isExpanded: isDetailExpanded)"))
