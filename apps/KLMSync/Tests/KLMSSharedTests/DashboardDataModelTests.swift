...
final class DashboardDataModelTests: XCTestCase {
    ...
    func testMacDashboardWindowFollowsApprovedWorkstationMockup() throws {
        ...
        XCTAssertTrue(rootActionButtonStyle.contains(".frame(minWidth: 36, minHeight: 36)"))
        XCTAssertTrue(actionButtonStyle.contains(".frame(minWidth: 36, minHeight: 36)"))
    ...
    func testIOSDashboardAndSettingsFollowDesignNavigation() throws {
        ...
        XCTAssertTrue(statusScreen.contains("title: \"항목 선택\""))
        ...
        XCTAssertTrue(immediateSettingsPanel.contains(".accessibilityLabel(\"화면 모드\")"))
        XCTAssertTrue(immediateSettingsPanel.contains(".accessibilityValue(KLMSAppearanceMode(rawValue: model.sharedAppearanceModeValue)?.title ?? \"시스템\")"))
        XCTAssertTrue(immediateSettingsPanel.contains(".accessibilityHint(\"KLMS Sync 화면을 시스템 설정, 라이트 모드, 다크 모드 중 하나로 바꿉니다.\")"))
        ...
        XCTAssertTrue(remoteSettingGroupSection.contains("group.hasExpandedDetail && group.isCollapsible && isExpanded"))
    ...
    func testMacAndIOSUseDedicatedLogScreensForRequestHistory() throws {
        ...
        XCTAssertTrue(iosStatusScreen.contains("title: \"항목 선택\""))
