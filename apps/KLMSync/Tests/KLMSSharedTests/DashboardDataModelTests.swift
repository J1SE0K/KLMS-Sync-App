...
final class DashboardDataModelTests: XCTestCase {
    ...
    func testIOSDashboardAndSettingsFollowDesignNavigation() throws {
        ...
        XCTAssertTrue(categoryLoadingState.contains("CompanionDashboardDataLoadingCard(isServerConfigured: isServerConfigured)"))
    ...
    func testSettingsPanelsAreGroupedAndUseNaturalKoreanCopy() throws {
        ...
        XCTAssertTrue(remoteSettingGroup.contains("return RemoteSettingGroup(title: title, systemImage: systemImage, detail: detail, settings: groupSettings)"))
    ...
    func testIOSLargeDashboardListsRenderAllItemsLazily() throws {
        ...
        XCTAssertTrue(companionModel.contains("let sortedDashboardItems = dashboardSyncItems.companionSorted(by: .recent)"))
        ...
        XCTAssertTrue(companionModel.contains("for item in syncItems.companionSorted(by: .recent)"))
