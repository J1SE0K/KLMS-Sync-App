...
final class DashboardDataModelTests: XCTestCase {
    ...
    func testMacWorkspaceAccessibilitySmokeScriptTargetsNavigation() throws {
        ...
        XCTAssertTrue(script.contains("var renderedIdentifier: String { \"workspace-rendered-section-\\(rawValue)\" }"))
        ...
        XCTAssertTrue(script.contains("for identifier in [target.scrollIdentifier, target.panelIdentifier, target.renderedIdentifier]"))
    ...
    func testIOSLargeDashboardListsRenderAllItemsLazily() throws {
        ...
        XCTAssertFalse(deferredInlineItemDetail.contains("Task.sleep"))
