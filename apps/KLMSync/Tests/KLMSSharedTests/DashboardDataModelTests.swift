...
final class DashboardDataModelTests: XCTestCase {
    ...
    func testMacAndIOSUseDedicatedLogScreensForRequestHistory() throws {
        ...
        XCTAssertTrue(ios.contains("let leftKLMSTimestamp = lhs.dashboardTimestampEpoch"))
        XCTAssertTrue(ios.contains("return leftKLMSTimestamp > rightKLMSTimestamp"))
        XCTAssertTrue(ios.contains("if lhs.kind != \"file\" || rhs.kind != \"file\""))
