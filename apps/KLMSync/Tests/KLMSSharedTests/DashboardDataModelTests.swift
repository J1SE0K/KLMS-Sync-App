...
final class DashboardDataModelTests: XCTestCase {
    ...
    func testMacDashboardWindowFollowsApprovedWorkstationMockup() throws {
        ...
        XCTAssertTrue(commandPanel.contains(".onTapGesture"))
        XCTAssertTrue(commandPanel.contains(".accessibilityAction"))
        XCTAssertTrue(commandPanel.contains("runOrCancelIfAvailable(command, isDisabled: isDisabled)"))
        XCTAssertTrue(commandPanel.contains("cancelRunningCommandIfAvailable()"))
        ...
        XCTAssertFalse(commandPanel.contains(".buttonStyle(MacPressFeedbackButtonStyle(cornerRadius: 12, disabledOpacity: 1.0))"))
        XCTAssertFalse(commandPanel.contains(".buttonStyle(MacPressFeedbackButtonStyle(disabledOpacity: 1.0))"))
        ...
        XCTAssertTrue(commandPanel.contains(".accessibilityRespondsToUserInteraction(!isDisabled)"))
        ...
        XCTAssertTrue(pressFeedbackStyle.contains("Color.klmsMacCommandButtonPressedOverlay.opacity(0.0)"))
