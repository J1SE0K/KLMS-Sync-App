...
final class DashboardDataModelTests: XCTestCase {
    ...
    func testIOSDeviceInstallHelperWaitsForUnavailableDevices() throws {
        ...
        XCTAssertTrue(installScript.contains("install-summary installed_ready=${installed_ready_count} manual_launch_needed=${manual_launch_count} failed=${failed_count}"))
        ...
        XCTAssertTrue(readme.contains("install-summary installed_ready=... manual_launch_needed=... failed=..."))
