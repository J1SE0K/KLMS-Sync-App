...
final class DashboardDataModelTests: XCTestCase {
    ...
    func testMacAndIOSUseDedicatedLogScreensForRequestHistory() throws {
        ...
        XCTAssertTrue(deferredMacWorkspacePanel.contains(".accessibilityIdentifier(\"workspace-loading-\\(contentIdentifier ?? id)\")"))
        ...
        XCTAssertTrue(macWorkstationLayoutView.contains(".accessibilityIdentifier(\"workspace-content-\\(selectedSection.rawValue)\")"))
