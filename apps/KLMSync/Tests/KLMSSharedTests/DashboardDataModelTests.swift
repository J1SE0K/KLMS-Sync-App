...
final class DashboardDataModelTests: XCTestCase {
    ...
    func testMacDashboardWindowFollowsApprovedWorkstationMockup() throws {
        ...
        XCTAssertTrue(navigationView.contains("isSelected ? Color.klmsMacPrimaryCommandButtonBackground : Color.klmsMacSubtleCardBackground"))
        XCTAssertTrue(navigationView.contains("isSelected ? Color.klmsMacPrimaryCommandButtonBorder : Color.klmsMacCommandBorder"))
    ...
    func testMacAndIOSUseSeparatedLightAndDarkThemeTokens() throws {
        ...
        XCTAssertTrue(ios.contains("Image(systemName: \"play.fill\")"))
    ...
    func testIOSDashboardAndSettingsFollowDesignNavigation() throws {
        ...
        XCTAssertTrue(compactTabBar.contains("? Color.klmsPrimaryCommandButtonBackground"))
        XCTAssertTrue(compactTabBar.contains(": Color.klmsSubtleCardBackground"))
        XCTAssertTrue(compactTabBar.contains("isSelected ? Color.klmsPrimaryCommandButtonBorder : Color.klmsBorder"))
        ...
        XCTAssertTrue(dashboardSyncCard.contains("Text(\"전체 동기화\")"))
        ...
        XCTAssertTrue(remoteCommandPanel.contains("Text(\"전체 동기화\")"))
        ...
        XCTAssertTrue(flowChipLayout.contains("selectedKind == entry.kind ? Color.klmsCommandButtonForeground : entry.kind.tint"))
    ...
    func testMacAndIOSUseDedicatedLogScreensForRequestHistory() throws {
        ...
        XCTAssertTrue(mac.contains("selected ? Color.klmsMacPrimaryCommandButtonBackground : Color.klmsMacSubtleCardBackground"))
        XCTAssertTrue(mac.contains("selected ? Color.klmsMacPrimaryCommandButtonBorder : Color.klmsMacCommandBorder"))
        XCTAssertTrue(macDesignWindow.contains("isSelected ? Color.klmsMacPrimaryCommandButtonBackground : Color.klmsMacCardBackground"))
        XCTAssertTrue(macDesignWindow.contains("isSelected ? Color.klmsMacCommandButtonForeground : Color.klmsMacPrimaryText"))
        ...
        XCTAssertTrue(iosSidebarButton.contains("Color.klmsPrimaryCommandButtonBackground"))
        ...
        XCTAssertTrue(iosMetricTile.contains("Color.klmsPrimaryCommandButtonBackground"))
        XCTAssertTrue(iosMetricTile.contains("Color.klmsCommandButtonForeground"))
