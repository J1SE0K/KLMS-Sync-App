...
final class DashboardDataModelTests: XCTestCase {
    ...
    func testMacDashboardWindowFollowsApprovedWorkstationMockup() throws {
        ...
        XCTAssertTrue(detail.contains("static let filterRebuildDelayNanoseconds: UInt64 = 80_000_000"))
    ...
    func testIOSDashboardAndSettingsFollowDesignNavigation() throws {
        ...
        XCTAssertTrue(dashboardSyncCard.contains("isDisabled ? Color.klmsPrimaryCommandButtonForeground.opacity(0.82) : Color.klmsPrimaryCommandButtonForeground"))
        XCTAssertTrue(dashboardSyncCard.contains("if isDisabled { return Color.klmsPrimaryCommandButtonBackground.opacity(0.72) }"))
        XCTAssertTrue(dashboardSyncCard.contains("if isDisabled { return Color.klmsPrimaryCommandButtonBorder.opacity(0.62) }"))
        ...
        XCTAssertTrue(remoteCommandPanel.contains("isDisabled ? Color.klmsPrimaryCommandButtonForeground.opacity(0.82) : Color.klmsPrimaryCommandButtonForeground"))
        XCTAssertTrue(remoteCommandPanel.contains("if isDisabled { return Color.klmsPrimaryCommandButtonBackground.opacity(0.72) }"))
        XCTAssertTrue(remoteCommandPanel.contains("if isDisabled { return Color.klmsPrimaryCommandButtonBorder.opacity(0.62) }"))
