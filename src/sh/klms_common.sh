...
klms_init_context() {
  ...
  local -a runtime_override_keys=(
    ...
    FILE_SEED_UNCHANGED_COURSE_STALE_SECONDS
    FILE_NESTED_UNCHANGED_SEED_STALE_SECONDS
    FILE_NESTED2_UNCHANGED_NESTED_STALE_SECONDS
